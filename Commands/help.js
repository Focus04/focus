...
module.exports = {
    ...
    async execute(message, args) {
        ...
        if (!args.length) {
            ...
            let welcomecmds = '```' + `${prefix}setwelcomechannel, ${prefix}welcomemessage, ${prefix}togglewelcomemsg, ${prefix}welcomedm, ${prefix}togglewelcomedm, ${prefix}setleavechannel, ${prefix}leavemessage, ${prefix}toggleleavemsg` + '```';
